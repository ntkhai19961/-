package com.example.win7.apphoctiengnhat.Lesson.FabFragment;
...
/**
 * Created by ntkhai1996 on 25-Apr-18.
 */

public class LessonFabFragment extends AAH_FabulousFragment {
    ...
    public static LessonFabFragment newInstance() {
        LessonFabFragment mff = new LessonFabFragment();
        return mff;
    }
    ...
    private void getApplied_filter() {
        applied_filters = ((LessonActivity) getActivity()).getApplied_filters();
    }

    @Override
    public void setupDialog(Dialog dialog, int style) {

        View contentView = View.inflate(getContext(), R.layout.fragment_lesson_filter_view, null);
    ...
    private void inflateLayoutWithFilters(String filter_category, FlexboxLayout flexBoxLayout) {
        ...
        switch (filter_category) {
            case "degree":
                keys = ((LessonActivity) getActivity()).getListDegreeOrLevel(filter_category);
                break;
            case "level":
                keys = ((LessonActivity) getActivity()).getListDegreeOrLevel(filter_category);
                break;
