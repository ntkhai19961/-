...
public class FavoriteRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public static class FavoriteViewHolder extends RecyclerView.ViewHolder {
        ...
        public FavoriteViewHolder(final View itemView) {
            ...
            mOriginalTextView = itemView.findViewById(R.id.item_favorite_text_view_original);

            mTranslateTextView = itemView.findViewById(R.id.item_favorite_text_view_translate);

            mLangsTextView = itemView.findViewById(R.id.item_favorite_text_view_langs);

            mFavoriteCheckBox = itemView.findViewById(R.id.item_favorite_checkbox_favorite);
