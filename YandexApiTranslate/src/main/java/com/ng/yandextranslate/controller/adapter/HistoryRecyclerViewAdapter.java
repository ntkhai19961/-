...
public class HistoryRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static class HistoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public HistoryViewHolder(View itemView) {
            ...
            mOriginalTextView = itemView.findViewById(R.id.item_text_view_original);

            mTranslateTextView = itemView.findViewById(R.id.item_text_view_translate);

            mLangsTextView = itemView.findViewById(R.id.item_text_view_langs);

            mFavoriteCheckBox = itemView.findViewById(R.id.item_checkbox_favorite);
        }
    }
}
