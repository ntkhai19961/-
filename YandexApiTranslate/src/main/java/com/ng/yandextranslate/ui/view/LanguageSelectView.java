...
public class LanguageSelectView extends LinearLayout {
    ...
    ImageButton mSwapImageButton = findViewById(R.id.language_select_swap_button);

    //@BindView(R.id.language_select_spinner_from)
    Spinner mFromSpinner = findViewById(R.id.language_select_spinner_from);

    //@BindView(R.id.language_select_spinner_to)
    Spinner mToSpinner = findViewById(R.id.language_select_spinner_to);
